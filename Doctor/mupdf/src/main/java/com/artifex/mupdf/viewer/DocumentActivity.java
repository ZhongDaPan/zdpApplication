...
public class DocumentActivity extends Activity {
    ...
    private void makeButtonsView() {
        ...
        topleft = (ImageView) mButtonsView.findViewById(R.id.top_left);
        tvRigth = (TextView) mButtonsView.findViewById(R.id.tv_right);
        tvSignReport = (TextView) mButtonsView.findViewById(R.id.tv_sign_report);
