...
//                        }
    ...
    private void register() {
        ...
        if (TextUtils.isEmpty(hospitalMessageBean.getHospitalName())) {
            toast("请选择医院");
            return;
        }
        ...
        bodyMap.put("HospitalId", hospitalMessageBean.getHospitalId() + "");//医院id
        bodyMap.put("HospitalName", hospitalMessageBean.getHospitalName());//医院名称
