...
public class FenjiZhuanzhenActivity extends BasicActivity implements OnPrescriptionChangeListener {
    ...
    protected void initView() {
        ...
        adapter = new MyFragmentAdapter(getSupportFragmentManager(), FenjiZhuanzhenActivity.this, mList, tabTitles);
    ...
    private void setTitle(int consultUnread, int consultingUnread) {
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            RelativeLayout unReadLayout = (RelativeLayout) tab1.getCustomView().findViewById(R.id.unRead_layout);
            TextView unreadNum = (TextView) tab1.getCustomView().findViewById(R.id.unread_num);
