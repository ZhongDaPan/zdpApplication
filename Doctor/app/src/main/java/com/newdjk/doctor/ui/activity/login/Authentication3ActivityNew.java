...
//                        }
                        ...
                        if (mSavePicList1.size() == 0 || mSavePicList2.size() == 0) {
                            toast("请将执业证，资格证上传完整！");
                            return;
                        }
//                        if (TextUtils.isEmpty(zyz)) {
