...
public class VideoInterrogationExpandAdapter  extends AnimatedExpandableListView.AnimatedExpandableListAdapter {
    ...
    public VideoInterrogationExpandAdapter(Context mContext) {
    ...
    public View getRealChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
      ...
      final  AllRecordForDoctorEntity allRecordForDoctorEntity =mList.get(groupPosition).getAllRecordForDoctorEntity().get(childPosition);
        ...
        if (allRecordForDoctorEntity != null) {
            ...
            try {
                String time = TimeUtil.getChatTimeStr(allRecordForDoctorEntity.getTimeStamp());
                childViewHolder.create_time.setText(time);
            } catch (Exception e) {
                e.printStackTrace();
            }
            ...
            try {
                if (reExaminationDate != null && reExaminationStartTime!= null && reExaminationEndTime!= null) {
                    childViewHolder.appointment_time.setText(reExaminationDate.substring(0,reExaminationDate.indexOf(" "))+" "+reExaminationStartTime+"-"+reExaminationEndTime);
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
