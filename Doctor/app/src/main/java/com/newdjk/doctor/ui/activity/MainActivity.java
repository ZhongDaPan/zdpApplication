...
import com.newdjk.doctor.ui.entity.CertificateEntity;
...
//        }
    ...
    protected void initData() {
        ...
        rbTab4.setChecked(false);
        BJCASDK.getInstance().getUserInfo(this, Contants.clientId, new
                YWXListener() {
                    public void callback(String message) {
                        if (message != null && !message.equals("")) {
                            CertificateEntity CertificateEntity = new Gson().fromJson(message, CertificateEntity.class);
                            if (CertificateEntity != null) {
                                if (!CertificateEntity.isDeviceFit()) {
                                    BJCASDK.getInstance().clearCert(MainActivity.this);
                                }
                            }
